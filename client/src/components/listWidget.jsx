...
export default function ListWidget({ isAuthenticated, listItems, setListOpen }) {
  ...
  return (
    ...
    >
      ...
      {itemCount > 0 && (
        <span data-testid='list-widget-count' className='absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center'>
